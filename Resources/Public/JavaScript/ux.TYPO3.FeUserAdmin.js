Ext.namespace('MvcExtjsSamples.FeUserAdmin'); 

MvcExtjsSamples.FeUserAdmin.components = function() {

	return {
		init: function() {

			var store = new Ext.data.GroupingStore({
			    reader: MvcExtjsSamples.FeUserAdmin.storeFields,
			...
			var chart = new Ext.Panel({
			    ...
			    items: {
			        xtype: 'columnchart',
			        store: cstore,
			        url:  MvcExtjsSamples.FeUserAdmin.chartUrl,
			        xField: 'month',
