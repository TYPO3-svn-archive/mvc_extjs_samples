...
Ext.namespace('MvcExtjsSamples.Movie'); 

MvcExtjsSamples.Movie.GridPanel = Ext.extend(Ext.grid.GridPanel, {
	constructor: function(config) {
		...
		config = Ext.apply({
			title: 'Movie List',
			region: "center",
			store: new MvcExtjsSamples.ViewBasedModule.MovieStore,
			columns: MvcExtjsSamples.ViewBasedModule.MovieColumns,
			loadMask: {
				msg: 'loading ...',
			},
			plugins: [editor],
